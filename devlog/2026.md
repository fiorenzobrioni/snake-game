...
- **Tower Topper vs Full Circle.** They read as the same feat ("reach Level 10" / "clear all ten
  levels"). Reworded Full Circle to "Loop the campaign: clear all ten levels to reach Speed 2" so it is
  clearly the *full lap* milestone, distinct from topping the tower at Level 10.
